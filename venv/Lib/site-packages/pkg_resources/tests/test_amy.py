...
class TestAmy(TestCase):
    def setUp(self):
        ...
        total=self.Tester.total_email_count()
        if total>50:
            total=50
        if total<=50:
             for n in sample(range(1,total+1),total-1):
    ...
    def test1(self):
        ...
        # for email in self.Tester.email_list:
        #     self.assertTrue(email in self.Tester.email_priority_dict.keys())
        #
        # for priority in self.Tester.priorities:
        #     self.assertTrue(priority in self.Tester.email_priority_dict.values())
